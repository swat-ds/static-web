$.getJSON("/assets/scripts/lunr-index.json", function(index_json) {
...
var result = '<div class="result"><a href="http://proposals.monumentlab.com/monuments/' + item.pid + '"><img class="sq-thumb-sm" src="http://proposals.monumentlab.com/assets/monuments/thumbs/' + item.image_file_name + '"/>&nbsp;&nbsp;&nbsp;<p><span class="title">' + item.title + '.</span><br>' + meta + '</p></a></div>';
